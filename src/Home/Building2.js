      ...
      <View
        ...
        <ButtonStyle
          ...
          onPress={async () => {
            ...
            url = 'https://somalease.com/admin/api/sub_post_properties_step1';
            ...
            // return;
            Global.Add_Flat_Lat_Lon = {Lat: data.latitude, Lon: data.longitude, locality:data.locality, street_landmark: data.street_landmark}
            fetch(url, {
              method: 'Post',
              headers: {
              ...
              .then(responseJson => {
                ...
                if (responseJson.status == true) {
                  Global.Add_Flat_ID = responseJson.data.id
                  // alert('Thankyou for Registering With us');
                  // navigation.navigate('OwnerProperty1', {
                  //   item: {
                  //     item: data,
                  //     item1: responseJson.data,
